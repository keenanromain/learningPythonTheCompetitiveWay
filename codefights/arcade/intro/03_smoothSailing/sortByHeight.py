...
"""
Reasoning~
We can create a new sorted array of all non-tree elements from the first array to
have the proper order of people. Next, we can then iterate over our original list and
replace every non-tree instance with the corresponding element stored in the sorted list.
"""